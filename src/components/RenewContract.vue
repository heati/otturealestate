<template>
  <div class="renew-contract">
                    ...
                    >
                      ...
                      <v-menu
                        ...
                        <v-flex xs4 md2 class="text-xs-right">
                          <v-btn  dark class="re-orangtbtn">EDIT PRICE</v-btn>
                        </v-flex>
                        </v-layout>
        ...
        <div class="text-xs-center mt-4">
          <v-btn  dark class="re-orangtbtn" to = "/renew_contract_list">SAVE</v-btn>
          <v-btn dark to="rent_management">CANCEL</v-btn>
        </div>
  </div>
</template>
