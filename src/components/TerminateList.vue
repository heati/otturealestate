              ...
              <v-layout class="pt-5"  wrap>
                <v-flex grow pa-1 xs10 sm7 md8>
                  <v-layout align-start wrap>
                    <v-flex xs6 sm4>
                      <h2 class="display-2">Terminate Contract List</h2>
                    </v-flex>
                    <v-flex xs6 sm8>
                      <v-select
                        :items="items3"
                ...
                <v-layout style="overflow:auto">
                  ...
                  >
                    <template v-slot:items="props">
                      ...
                      <td class="text-xs-center">
                        <div>{{ props.item.terminationDate }}</div>
                    </td>
                      </tr>
                    </template>
                  </v-data-table>
  ...
  name: 'TerminateList',
        ...
        data: () => ({
          ...
          headers1: [
            ...
            { text: "TERMINATION DATE", align: "center", sortable: false },
          ],
